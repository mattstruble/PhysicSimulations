...
void RigidBodySystem::Initialize(PhysicObjectHandler* handler)
{
	...
	rbSphere->Initialize(Vector3D(0, 10, 5), 1, Color::MAGENTA);
	...
	rbSphere2->Initialize(Vector3D(0, 20, 0),1 , Color::GREEN);
	...
	rbSphere3->Initialize(Vector3D(10, 10, 0), 1, Color::RED);
